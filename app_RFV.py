...
def main():
    ...
    st.set_page_config(page_title = 'Análise de perfil de corretista com RFV', \
        page_icon = 'https://cdn-icons-png.flaticon.com/512/3399/3399316.png',
        layout="wide",
    ...
    st.write("- V - Valor: somatório do valor de todos os produtos adquirido no decorrer do periodo avaliado.")
    st.markdown("---")
    st.markdown("Siga os resultados abaixo:")
    ...
    st.sidebar.write("## Suba o arquivo em .csv ou .xlsx")
